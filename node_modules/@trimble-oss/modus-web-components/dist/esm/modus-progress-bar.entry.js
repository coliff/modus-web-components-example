...
let ModusProgressBar = class {
  ...
  render() {
    ...
    return (h("div", { "aria-label": this.ariaLabel, "aria-valuemax": this.maxValue, "aria-valuemin": this.minValue, "aria-valuenow": this.value, class: progressBarClass, role: "progressbar", style: this.getProgressBarStyle() }, h("div", { class: progressClass, style: this.getProgressStyle(percentage) }, this.text)));
  }
};
