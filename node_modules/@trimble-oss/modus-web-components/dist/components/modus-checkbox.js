...
let ModusCheckbox$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
ModusCheckbox$1 = /*@__PURE__*/ proxyCustomElement(ModusCheckbox$1, [1, "modus-checkbox", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "modus-checkbox":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusCheckbox$1);
      }
      break;
  } });
}

const ModusCheckbox = ModusCheckbox$1;
const defineCustomElement = defineCustomElement$1;

export { ModusCheckbox, defineCustomElement };
