...
let ModusSelect$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
ModusSelect$1 = /*@__PURE__*/ proxyCustomElement(ModusSelect$1, [1, "modus-select", {
    ...
    "activeItemIndex": [32],
    "visible": [32]
  }, [[4, "click", "documentClickHandler"], [0, "keydown", "elementKeydownHandler"]]]);
  ...
  components.forEach(tagName => { switch (tagName) {
    case "modus-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusSelect$1);
      }
      break;
  } });
}

const ModusSelect = ModusSelect$1;
const defineCustomElement = defineCustomElement$1;

export { ModusSelect, defineCustomElement };
