...
import { I as IconSearch } from './icon-search.js';
...
let ModusTextInput$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
ModusTextInput$1 = /*@__PURE__*/ proxyCustomElement(ModusTextInput$1, [1, "modus-text-input", {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "modus-text-input":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusTextInput$1);
      }
      break;
  } });
}

const ModusTextInput = ModusTextInput$1;
const defineCustomElement = defineCustomElement$1;

export { ModusTextInput, defineCustomElement };
