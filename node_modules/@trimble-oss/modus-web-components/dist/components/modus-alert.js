...
import { I as IconError, a as IconCheckCircle, b as IconWarning } from './icon-check-circle.js';
...
let ModusAlert$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
ModusAlert$1 = /*@__PURE__*/ proxyCustomElement(ModusAlert$1, [1, "modus-alert", {
