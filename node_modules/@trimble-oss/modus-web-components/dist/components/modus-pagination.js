...
const IconChevronLeftThick = (props) => {
  var _a, _b, _c;
  return (h("svg", { height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    h("mask", { id: "mask0_434_74", maskUnits: "userSpaceOnUse", x: "6", y: "5", width: "8", height: "10" },
      h("path", { d: "M13.0875 6.175L11.9125 5L6.91248 10L11.9125 15L13.0875 13.825L9.27081 10L13.0875 6.175Z", fill: "white" })),
    h("g", { mask: "url(#mask0_434_74)" },
      h("path", { d: "M13.0875 6.175L11.9125 5L6.91248 10L11.9125 15L13.0875 13.825L9.27081 10L13.0875 6.175Z", fill: (_c = props.color) !== null && _c !== void 0 ? _c : '#6A6976' }))));
};
...
const IconChevronRightThick = (props) => {
  var _a, _b, _c;
  return (h("svg", { height: (_a = props.size) !== null && _a !== void 0 ? _a : 16, width: (_b = props.size) !== null && _b !== void 0 ? _b : 16, viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    h("mask", { id: "mask0_434_80", maskUnits: "userSpaceOnUse", x: "6", y: "5", width: "8", height: "10" },
      h("path", { d: "M8.08748 5L6.91248 6.175L10.7291 10L6.91248 13.825L8.08748 15L13.0875 10L8.08748 5Z", fill: "white" })),
    h("g", { mask: "url(#mask0_434_80)" },
      h("path", { d: "M8.08748 5L6.91248 6.175L10.7291 10L6.91248 13.825L8.08748 15L13.0875 10L8.08748 5Z", fill: (_c = props.color) !== null && _c !== void 0 ? _c : '#6A6976' }))));
};
...
let ModusPagination$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    this.setPages();
    return (h("nav", { "aria-label": this.ariaLabel, class: `${this.classBySize.get(this.size)}` }, h("ol", null, this.maxPage - this.minPage >= 7 &&
      h("li", { class: `${this.activePage != this.minPage ? 'hoverable' : 'disabled'}`, onClick: () => this.handleChevronClick('back'), onKeyDown: (event) => this.handleKeydownBack(event), tabIndex: 0 }, h(IconChevronLeftThick, { size: this.chevronSizeBySize.get(this.size) })), this.pages.map(page => {
      ...
      h("li", { class: `${this.activePage != this.maxPage ? 'hoverable' : 'disabled'}`, onClick: () => this.handleChevronClick('forward'), onKeyDown: (event) => this.handleKeydownForward(event), tabIndex: 0 }, h(IconChevronRightThick, { size: this.chevronSizeBySize.get(this.size) })))));
  }
  static get style() { return modusPaginationCss; }
};
ModusPagination$1 = /*@__PURE__*/ proxyCustomElement(ModusPagination$1, [1, "modus-pagination", {
    "ariaLabel": [1, "aria-label"],
    "activePage": [2, "active-page"],
    "maxPage": [2, "max-page"],
    "minPage": [2, "min-page"],
    "size": [1],
    "pages": [32]
  ...
  components.forEach(tagName => { switch (tagName) {
    case "modus-pagination":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusPagination$1);
      }
      break;
  } });
}

const ModusPagination = ModusPagination$1;
const defineCustomElement = defineCustomElement$1;

export { ModusPagination, defineCustomElement };
