...
let ModusButton = class {
  ...
  render() {
    ...
    return (index.h("button", { "aria-disabled": this.disabled, "aria-label": this.ariaLabel, "aria-pressed": this.pressed, class: className, disabled: this.disabled, onClick: () => !this.disabled ? this.buttonClick.emit() : null, onKeyDown: () => this.pressed = true, onKeyUp: () => this.pressed = false, onMouseDown: () => this.pressed = true, onMouseUp: () => this.pressed = false, role: "button" }, index.h("slot", null)));
  }
