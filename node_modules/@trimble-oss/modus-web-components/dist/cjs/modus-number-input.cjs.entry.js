...
let ModusNumberInput = class {
  ...
  render() {
    ...
    return (index.h("div", { "aria-disabled": this.disabled, "aria-label": this.ariaLabel, "aria-placeholder": this.placeholder, "aria-invalid": !!this.errorText, "aria-readonly": this.readOnly, "aria-required": this.required, "aria-valuemax": this.maxValue, "aria-valuemin": this.minValue, "aria-valuenow": this.value, class: className }, this.label || this.required
      ...
      : null, index.h("div", { class: inputContainerClassName }, index.h("input", { disabled: this.disabled, max: this.maxValue, min: this.minValue, onInput: () => this.handleOnInput(), placeholder: this.placeholder, readonly: this.readOnly, ref: (el) => this.numberInput = el, step: this.step, tabIndex: 0, type: "number", value: this.value })), this.errorText ? index.h("label", { class: "sub-text error" }, this.errorText) :
