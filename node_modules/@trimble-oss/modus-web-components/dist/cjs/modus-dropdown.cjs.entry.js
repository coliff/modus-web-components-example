...
let ModusDropdown = class {
  ...
  render() {
    ...
    return (index.h("div", { "aria-label": this.ariaLabel, class: "dropdown", role: "listbox" }, index.h("slot", { name: "dropdownToggle" }), index.h("div", { class: listContainerClass, style: { 'left': left, 'min-width': width } }, index.h("slot", { name: "dropdownList" }))));
  }
};
