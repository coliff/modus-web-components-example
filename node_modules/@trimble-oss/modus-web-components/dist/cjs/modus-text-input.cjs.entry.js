...
let ModusTextInput = class {
  ...
  render() {
    ...
    return (index.h("div", { "aria-disabled": this.disabled, "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel, "aria-placeholder": this.placeholder, "aria-readonly": this.readOnly, "aria-required": this.required, class: className }, this.label || this.required
