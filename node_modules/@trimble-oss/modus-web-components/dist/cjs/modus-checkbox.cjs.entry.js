...
const iconCheck = require('./icon-check-1461a030.js');

// eslint-disable-next-line
const IconIndeterminate = (props) => {
  var _a, _b, _c, _d;
  return (index.h("svg", { class: "icon-check", width: (_a = props.size) !== null && _a !== void 0 ? _a : 16, height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, viewBox: "-3 0 24 4", onClick: props.onClick ? () => props.onClick() : null, fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    index.h("path", { d: "M1 3V1H17V3H1Z", fill: (_c = props.color) !== null && _c !== void 0 ? _c : '#6A6976', stroke: (_d = props.color) !== null && _d !== void 0 ? _d : '#6A6976' })));
};
...
let ModusCheckbox = class {
  ...
  render() {
    ...
    return (index.h("div", { class: className, onClick: () => this.handleCheckboxClick(), tabIndex: 0 }, index.h("div", { class: `${this.checked || this.indeterminate ? 'checkbox blue-background' : 'checkbox'} ${this.disabled ? 'disabled' : ''}` }, this.indeterminate
      ? index.h("div", { class: 'checkmark checked' }, index.h(IconIndeterminate, { color: "#FFFFFF", size: "24" }))
      : index.h("div", { class: this.checked ? 'checkmark checked' : 'checkmark' }, index.h(iconCheck.IconCheck, { color: "#FFFFFF", size: "24" }))), index.h("input", { "aria-checked": this.checked, "aria-disabled": this.disabled, "aria-label": this.ariaLabel, checked: this.checked, disabled: this.disabled, ref: (el) => this.checkboxInput = el, type: "checkbox" }), this.label ? index.h("label", { class: this.disabled ? 'disabled' : null }, this.label) : null));
  }
};
