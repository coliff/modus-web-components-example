...
let ModusChip = class {
  ...
  render() {
    ...
    `;
    return (index.h("div", { "aria-disabled": this.disabled, "aria-label": this.ariaLabel, class: chipClass, onClick: this.disabled ? null : (event) => this.onChipClick(event), tabIndex: 0 }, this.imageUrl ? index.h("img", { src: this.imageUrl }) :
      this.showCheckmark ? index.h(iconCheck.IconCheck, { size: '24' }) :
        null, index.h("span", null, this.value), this.showClose ? index.h(IconRemove, { onClick: this.disabled ? null : (event) => this.onCloseClick(event), size: '24' }) :
      null));
  }
};
