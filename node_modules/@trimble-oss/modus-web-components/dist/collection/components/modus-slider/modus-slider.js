...
export class ModusSlider {
  ...
  render() {
    ...
    return (h("div", { "aria-disabled": this.disabled, "aria-label": this.ariaLabel, "aria-valuemax": this.maxValue, "aria-valuemin": this.minValue, "aria-valuenow": this.value, class: className },
      this.label && h("label", null, this.label),
      h("input", { class: "slider", disabled: this.disabled, max: this.maxValue, min: this.minValue, onChange: (event) => this.handleOnChange(event), onInput: (event) => this.handleOnInput(event), type: "range", value: this.value })));
  }
