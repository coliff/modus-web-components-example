...
export class ModusSwitch {
  ...
  render() {
    ...
    return (h("div", { class: containerClassName, onClick: () => this.handleSwitchClick(), tabIndex: 0 },
      h("div", { class: switchClassName },
        h("span", { class: "slider" })),
      h("input", { "aria-checked": this.checked, "aria-disabled": this.disabled, "aria-label": this.ariaLabel, checked: this.checked, disabled: this.disabled, ref: (el) => this.checkboxInput = el, role: "switch", type: "checkbox" }),
