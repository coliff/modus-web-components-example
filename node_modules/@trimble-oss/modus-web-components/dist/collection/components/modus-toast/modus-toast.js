...
export class ModusToast {
  ...
  render() {
    ...
    return (h("div", { "aria-label": this.ariaLabel, class: className, role: "status" },
      this.showIcon && icon,
      h("span", { class: 'text' },
        h("slot", null)),
      h("span", { class: 'close' }, this.dismissible && h(IconClose, { size: '18', onClick: () => this.dismissClick.emit() }))));
  }
  ...
  static get properties() { return {
    ...
    "type": {
      ...
      "mutable": false,
      "complexType": {
        "original": "'danger' | 'dark' | 'default' | 'primary' | 'secondary' | 'success' | 'tertiary' | 'warning'",
        "resolved": "\"danger\" | \"dark\" | \"default\" | \"primary\" | \"secondary\" | \"success\" | \"tertiary\" | \"warning\"",
        "references": {}
      },
      "required": false,
      "optional": false,
