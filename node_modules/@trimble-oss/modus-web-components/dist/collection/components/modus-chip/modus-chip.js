...
export class ModusChip {
  ...
  render() {
    ...
    `;
    return (h("div", { "aria-disabled": this.disabled, "aria-label": this.ariaLabel, class: chipClass, onClick: this.disabled ? null : (event) => this.onChipClick(event), tabIndex: 0 },
      this.imageUrl ? h("img", { src: this.imageUrl }) :
        this.showCheckmark ? h(IconCheck, { size: '24' }) :
          null,
      h("span", null, this.value),
      this.showClose ? h(IconRemove, { onClick: this.disabled ? null : (event) => this.onCloseClick(event), size: '24' }) :
        null));
  }
